...
def get_plot(request):
    ...
    obs_result = Observation.objects.filter(ra__gte = min_ra, ra__lte = max_ra, dec__gte = min_dec, dec__lte = max_dec, field_of_view__lte = 120)#.prefetch_related('spec_windows').prefetch_related('traces')
